...
<!--        我的发布和捐赠-->
        <div class="pub-and-don">
               <a class="pub-one pub-border" href="personal/my-send.html">
...
<!--        修改个人信息意见反馈等模块-->
        <div class="list">
            <ul>
                <li>
                    <a href="personal/update-personal-info.html" class="item">
                ...
                <li>
                    <a href="personal/advice.html" class="item">
                ...
                <li>
                    <a href="personal/aboutUs.html" class="item">
