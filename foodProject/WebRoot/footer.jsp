    ...
    <ul class="list">
        <li>
            <div>
                ...
                <a class="text" href="index.html">二手书商城</a>
            </div>
        </li>
        <li>
            <div>
                <a class="pic plus"></a>
                <a class="text" href="seilBook.html">我要卖书</a>
            </div>
        </li>
        <li>
            <div>
                <a class="pic gift"></a>
                <a class="text" href="donateBook.html">图书捐赠</a>
            </div>
        </li>
        <li>
            <div>
                <a class="pic personal"></a>
                <a class="text" href="personal.html">个人中心</a>
            </div>
        </li>
    </ul>
</div>
